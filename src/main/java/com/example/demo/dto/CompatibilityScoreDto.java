...
public class CompatibilityScoreDto {
    ...
    public CompatibilityScoreDto(Long id, Long studentAId, Long studentBId, Double score, 
                                String compatibilityLevel, String detailsJson, LocalDateTime computedAt) {
        this.id = id;
